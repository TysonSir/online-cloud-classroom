...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-04-06 09:09:01
-- 服务器版本： 5.5.28
-- PHP Version: 5.6.21
...
(11, '高等数学', '王爱华', '0', '', 'uploads/images/20170404062818656.jpg', 0, 1491287300, 0, 2, 0);
...
(4, '01 多元函数极限', 'uploads\\courvideo\\20170406053736985.mp4', 1491291018, 0, 0, 0, 11),
(5, '02 多元函数连续性', 'uploads\\courvideo\\20170406053421288.mp4', 1491456933, 0, 0, 0, 11);
...
(1, '做一个加法计算器', 'C语言程序设计', '', '', '', 0, 0, 1488378755, 0, 2, 1),
(2, '原型开发的好处', '软件工程导论', '', '', '', 0, 0, 1488378815, 0, 4, 2),
(3, '做一个加法计算器', 'C语言程序设计', '', 'uploads/20170302144824771.php', '', 0, 0, 1488466122, 0, 2, 1),
(4, '原型开发的好处', '软件工程导论', '', 'uploads/20170317141343198.chm', '', 0, 0, 1489760025, 0, 4, 1),
(5, '二叉树叶子节点', '数据结构研究', '', 'uploads/20170402102429220.html', '', 0, 0, 1491128677, 0, 8, 4),
(6, '二叉树叶子节点', '数据结构研究', '', 'uploads/homework20170402103203786.jpg', '教师暂未评价', 66, 0, 1491129125, 0, 8, 4),
(7, '二叉树叶子节点', '数据结构研究', '', 'uploads/homework/20170402103437755.jpg', '', 0, 0, 1491129282, 0, 8, 4),
(8, '双循环链表', '数据结构研究', '', 'uploads/homework/20170402103739738.', '教师暂未评价', 80, 0, 1491129464, 0, 10, 4),
(9, '二叉树叶子节点', '数据结构研究', '', 'uploads/homework/20170403102908139.jpg', '做得不错', 90, 0, 1491215350, 0, 8, 1),
(10, '新建一个汽车类', '面向对象程序设计', '', 'uploads/homework/20170403105800767.jpg', '教师暂未评价', 60, 0, 1491217081, 0, 7, 4);
...
(1, '陈恩天', 'eyJpdiI6IjAzOVFES29ldXNuSjVyVUxCUmRzcnc9PSIsInZhbHVlIjoiUHVHSnlkdFBNQWhkY1d0YXQ5ZGMydz09IiwibWFjIjoiODJiZDU2NzQ5YThmZGNjNmIyNzcxNGFkNmE1MWY4ZmUwOWE2ZmUwYzgyY2E4ZmYwODU4ODI1Njc5YmQzMTVlYiJ9', '', '14301183', '0', '', '', '', 6, 0, 0),
...
(4, '蒋佳浩', 'eyJpdiI6IlNwMVwvZUI3Q0NhcW9xTzdmRWhaV0tnPT0iLCJ2YWx1ZSI6InJhaDVxcVY1eFFPc2hVaTUwT0t6TEE9PSIsIm1hYyI6IjI0ZGMwY2Y1YTEyYTlkMWNiNTgwOTIwMDVjNDVkMTBmNDZlZWQyMzMxNDJkY2JiMDQxOTAwMGRjMTZhNzMyMzcifQ==', '', '14301065', '0', '', '', '', 0, 0, 0);
...
(18, '', '111', 1491200770, 0, 4, 0),
(19, '', '123', 1491202630, 0, 1, 0),
(20, '', '123', 1491202632, 0, 1, 0),
(21, '', '123', 1491202637, 0, 1, 0),
(22, '', '456', 1491202648, 0, 1, 0);
...
(6, '蒋浩', 'eyJpdiI6IlNyOGcySjhHQktHa2c4WjNiMVVQZ0E9PSIsInZhbHVlIjoiam93Q2VkYnVKRWNXOW1uVXU5Y1ErUT09IiwibWFjIjoiNDBmMTQyMjAzYWRiNDc0MzIwODdlNjQ3M2Y2ZjkzODE1NTkxYWE0MjQ5YjZjMjY5MTA0Y2I4N2JhMDk0OTkxZCJ9', '', '', '', '', 'jianghao@163.com', '', 0, 0, 0);
...
--
ALTER TABLE `tu_course`
  MODIFY `cour_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `tu_courvideo`
  MODIFY `cv_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- 使用表AUTO_INCREMENT `tu_homework`
--
ALTER TABLE `tu_homework`
  MODIFY `hw_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `tu_talk`
  MODIFY `talk_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `tu_teacher`
  MODIFY `tea_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
