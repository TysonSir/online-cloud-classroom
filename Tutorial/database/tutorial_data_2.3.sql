...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-07-22 14:53:09
-- 服务器版本： 5.5.28
-- PHP Version: 5.6.21
...
(4, '面向对象练习', '面向对象程序设计（Java）', '', 'uploads/homework/20170722124327182.zip', '', 0, 0, 1500727425, 0, 3, 2);
...
(3, '面向对象练习', '请提交程序代码', 'uploads\\taskfile\\OOP练习.doc_20170722123524831.doc', 0, 0, 1508054400, 1, 3);
...
--
ALTER TABLE `tu_student`
  MODIFY `stu_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
