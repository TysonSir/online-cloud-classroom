...
<div class="result_wrap">
    <form action="{{url('admin/task/' . $field->task_id)}}" method="post">
        {{csrf_field()}}
        {{method_field('PUT')}}
        <table class="add_tab">
            <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="task_name" value="{{$field->task_name}}">
            ...
            <tr>
                ...
                <td>
                    <textarea name="task_description"> {{$field->task_description}}</textarea>
                    <p>描述可以写250个字</p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="date" class="sm" name="task_finaltime" value="{{date('Y-m-d H:i:s',$field->task_finaltime)}}">
            ...
            <tr>
                ...
                <td>
                    <div class="form-group">
                        ...
                        <input type="text" size="50" name="task_file" value="{{$field->task_file}}">
            ...
            <tr>
                <th>任务状态：</th>
                <td>
                    <label for=""><input name="task_state" value="1" type="radio" @if($field->task_state) checked @endif>任务发布状态</label>
                    <label for=""><input name="task_state" value="0" type="radio" @if($field->task_state == 0) checked @endif>任务暂不发布</label>
                </td>
            </tr>
            <tr>
                <th>排序：</th>
                <td>
                    <input type="text" class="sm" name="task_order"  value="{{$field->task_order}}">
                </td>
            </tr>
            <tr>
                <th></th>
