    ...
    <form action="{{url('admin/course')}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="cour_name">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" name="cour_teacher" value="">
                </td>
            </tr>
            ...
            <div class="form-group">
                ...
                <input type="text" size="50" name="cour_image">
            ...
            <tr>
                <th>课程简介：</th>
                <td>
                    <input type="text" class="lg" name="cour_title" value="0">
                </td>
            </tr>
            <tr>
                <th></th>
