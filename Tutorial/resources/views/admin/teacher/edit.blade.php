...
<div class="result_wrap">
    <form action="{{url('admin/teacher/' . $field->tea_id)}}" method="post">
        {{csrf_field()}}
        {{method_field('PUT')}}
        <table class="add_tab">
            <tbody>
            <tr>
                ...
                <td>
                    <input type="text" name="tea_name" value="{{$field->tea_name}}">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" name="tea_email" value="{{$field->tea_email}}">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th>排序：</th>
                <td>
                    <input type="text" class="sm" name="tea_order" value="{{$field->tea_order}}">
                </td>
            </tr>
            <tr>
                <th></th>
