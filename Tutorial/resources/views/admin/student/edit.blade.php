...
<div class="result_wrap">
    <form action="{{url('admin/student/' . $field->stu_id)}}" method="post">
        {{csrf_field()}}
        {{method_field('PUT')}}
        <table class="add_tab">
            <tbody>
            <tr>
                ...
                <td>
                    <input type="text" name="stu_name" value="{{$field->stu_name}}">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" name="stu_code" value="{{$field->stu_code}}">
                </td>
            </tr>
            <tr>
                <th>登录密码：</th>
                <td>
                    <input type="text" class="lg" name="stu_password" value="">
                </td>
            </tr>
            <tr>
                <th></th>
